<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    {{-- <x-nav-link :href="route('customer_dashboard')" target="_blank"
                        :active="request()->routeIs('customer_dashboard')">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            {{-- href="{{ route('tenants.change',$tenant->id) }}" --}}

                            {{-- <x-dropdown-link href="#">
                                {{ $tenant->name }}
                            </x-dropdown-link> --}}
                            <a href="{{ route('tenants.change',$tenant->id) }}"
                                class='@if(auth()->user()->current_tenant_id == $tenant->id) font-bold @endif block px-4 py-2 text-sm leading-5 text-gray-700
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- <x-responsive-nav-link :href="route('customer_dashboard')"
                :active="request()->routeIs('customer_dashboard')">
                {{ __('Customer Dashboard') }}
            </x-responsive-nav-link> --}}
        </div>
